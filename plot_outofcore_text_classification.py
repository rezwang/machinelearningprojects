# Text classification using an out-of-core approach: learning from data that doesnot fit into main memory
# Reuters-21578 as provided by the UCI ML repository. It will be automatically downloaded and uncompressed on first run.
